(() => {
    ...
    function imgUpload() {
        if (document.querySelector(".upload-img")) {
            ...
            const dropzone = document.getElementsByClassName("upload-img");
    ...
    function videoPlayer() {
        window.onload = document.querySelectorAll(".guarantee__video-body").forEach((video => {
            const videoBtn = video.querySelector(".guarantee__btn");
            const videoFrame = video.querySelector(".guarantee__video");
    ...
    function basketAdd() {
        ...
        let cartValue = document.querySelector(".header__basket > span");
        const speedAnimation = 1e3;
        document.addEventListener("click", (e => {
            const targetElement = e.target;
            if (targetElement.closest(".add_to_cart_button")) {
                const productSlide = targetElement.closest(".product");
                const productImage = productSlide.querySelector(".attachment-woocommerce_thumbnail");
    ...
    document.addEventListener("DOMContentLoaded", basketAdd);
